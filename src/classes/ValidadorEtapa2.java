...
public class ValidadorEtapa2 {
	...
	public static void main(String[] args){
		...
		Loja loja1 = new Loja ("E3", 5, e1, d1, 10);
		System.out.println("[OK] Classe Loja identificada (construtor com dois parâmetros)");
		
		Loja loja2 = new Loja ("E7", 20, 2000, e1, d1, 10);
		System.out.println("[OK] Classe Loja identificada (construtor com três parâmetros)" + loja2);
